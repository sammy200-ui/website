              ...
              <div className={`xl:flex xl:gap-4 ${post?.toc?.length ? 'xl:flex-row-reverse' : ''}`}>
                ...
                <div className='px-4 sm:px-6 w-full lg:max-w-6xl lg:mx-auto lg:px-8 xl:flex-1 xl:max-w-7xl overflow-x-hidden'>
                  ...
                  {post.releaseNoteLink && (
                    ...
                    <div className='mt-5 w-full rounded-lg bg-secondary-100 dark:bg-dark-card dark:border dark:border-border px-2 py-3 text-center'>
                      <div>
                      ...
                      <div>
                        ...
                        <span className='font-sans text-sm text-gray-800 dark:text-dark-text antialiased'>
                          Check&nbsp;
                          <Link
